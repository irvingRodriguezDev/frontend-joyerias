...
export const TOTAL_DINERO_GRAMOS = "TOTAL_DINERO_GRAMOS";
export const TOTAL_DINERO_GRAMOS_EXISTENTE = "TOTAL_DINERO_GRAMOS_EXISTENTE";
export const TOTAL_GRAMOS = "TOTAL_GRAMOS";
export const TOTAL_GRAMOS_EXISTENTE = "TOTAL_GRAMOS_EXISTENTE";
